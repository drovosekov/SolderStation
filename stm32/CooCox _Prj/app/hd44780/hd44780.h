...
#define HD44780_WaitBisyFlag            0       // Опрос флага занятости контроллера дисплея (иначе программная задержка). Если HD44780_WaitBisyFlag=0, то на ногу дисплея R/W нужно подать постоянный логический 0
