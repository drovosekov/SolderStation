...
#define PCF8574_i2cRate         300000  // Частота работы i2c при работе с pcf8574
#define PCF8574_TO              100    // Длительность ожидания таймаута операций на i2c при работе с pcf8574
